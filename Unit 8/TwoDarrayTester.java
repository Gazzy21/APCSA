public class TwoDarrayTester {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "The sum of the elements in the 2nd column should be -1 \t the method returned: " + sumSecondCol);
        System.out.println(
                "The sum of the elements in the 3rd column should be 12 \t the method returned: " + sumThirdCol);
        System.out.println(
                "The sum of the elements in the 4th column should be 16 \t the method returned: " + sumFourthCol);
    ...
    public static int sumRow(int[][] arr, int row) {
        // *****write code to return the sum of the elements in the specified row in the
        // 2-D array.
        int sum = 0;
